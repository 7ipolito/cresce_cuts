...
export function Sidebar() {
  return (
    <Collapsible.Root className="bg-blue-primary fixed left-0 right-0 top-0 z-20 flex flex-col gap-6 overflow-hidden border-b border-zinc-200 p-4 scrollbar-thin scrollbar-track-zinc-100 scrollbar-thumb-zinc-300 data-[state=open]:bottom-0 lg:bottom-0 lg:right-auto lg:h-auto lg:w-80 lg:max-w-64 lg:overflow-auto lg:border-b-0 lg:border-r lg:px-1 lg:py-8 dark:border-zinc-800 dark:bg-zinc-900">
